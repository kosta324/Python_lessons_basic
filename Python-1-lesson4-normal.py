...
pattern1 = '^[А-Я][а-я][А-Яа-я]*$'
result = re.search(pattern1, name)
if result:
    print('имя соответствует')
else:
    print('имя не соответствует')
pattern2 = '^[А-Я][а-я][А-Яа-я]*$'
result = re.search(pattern2, surname)
if result:
    print('фамилия соответствует')
else:
    print('фамилия не соответствует')
pattern3 = '^([a-z_0-9]+)@[a-z-0-9]+\.(ru|com|org)$'
result = re.search(pattern3, email)
if result:
    print('email соответствует')
else:
    print('email не соответствует')
